  ...
  return (
    <div className="flex flex-col gap-4 p-4 pb-20">
      ...
      <div className="border border-gray-200 rounded-lg p-4">
        <h3 className="text-base font-medium mb-2">{t('data.exportSection')}</h3>
        <ExportSection />
      </div>

      {/* Section 2: Import backup */}
      <div className="border border-gray-200 rounded-lg p-4">
        <h3 className="text-base font-medium mb-2">{t('data.importSection')}</h3>
        <ImportJSONSection />
      ...
      <div className="border border-gray-200 rounded-lg p-4">
        <h3 className="text-base font-medium mb-2">{t('data.syncSection')}</h3>
        <SyncInstructions />
      </div>
    </div>
  )
