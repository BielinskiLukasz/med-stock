...
export const en: TranslationDict = {
  ...
  locations: {
    ...
    emptyBody: 'Add a location to organize where you store medicines.',
    errorDuplicate: 'A location with this name already exists',
    deleteReassignTitle: 'Reassign stock before deleting',
    deleteReassignBody: '{n} active stock item(s) use this location. Choose where to move them, or clear it.',
    reassignLabel: 'Move to',
    reassignOther: 'Clear (set to Other)',
    confirmReassignDelete: 'Move & delete',
    reorderHint: 'Drag to reorder, or use the arrows',
  },
  data: {
    title: 'Data',
  ...
  form: {
    ...
    saving: 'Moving…',
    creating: 'Creating…',
    nextAddStock: 'Next: Add Stock',
    addStock: 'Add Stock',
    savingGeneric: 'Saving…',
    customUnitOption: 'Other...',
    customUnitPlaceholder: 'Custom unit',
    paoValuePlaceholder: 'e.g. 12',
    quantityPlaceholder: 'e.g. 20',
    packCountPlaceholder: 'e.g. 2',
  },
  filter: {
    title: 'Filter & Sort',
    sortBy: 'Sort by',
